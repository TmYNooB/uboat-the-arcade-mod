...
Set-EquipP16 "43U" "Calibre = 20, Range = 5000, ReloadTime = 0.1, MagazineSize = 120, HorizontalRecoil = 1, MinVerticalRecoil = -0.3, MaxVerticalRecoil = 0.7, SeriesTimeOffset = 0.1, RecoilDuration = 0.3, RecoilRecovery = 0.2, RecoilGrowthRate = 0.07, RecoilRecoveryRate = 0.99, SkippedShells = 1"
Set-EquipP16 "Artillery - 8.8 cm" "Calibre = 88, Range = 12000, ReloadTime = 0.1, MagazineSize = 1, HorizontalRecoil = 0.0, MinVerticalRecoil = 0.0, MaxVerticalRecoil = 0.0, SeriesTimeOffset = 0, RecoilDuration = 0.23, RecoilRecovery = 0.2, RecoilGrowthRate = 1.0, RecoilRecoveryRate = 0.996"
